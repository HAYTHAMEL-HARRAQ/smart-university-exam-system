    ...
    return (
      <div className="min-h-screen bg-gray-100 p-6">
        <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-lg p-8">
          <h1 className="text-3xl font-bold text-center mb-6">🎓 Exam Completed!</h1>
          <div className="text-center">
            <div className="text-6xl font-bold text-blue-600 mb-4">{score}%</div>
            <p className="text-xl mb-8">Your final exam score</p>
            <div className="mb-6 p-4 bg-blue-50 rounded-lg">
              <p className="text-blue-800">✅ Exam monitoring completed successfully</p>
              <p className="text-blue-600 text-sm mt-1">Camera feed and detection systems deactivated</p>
            </div>
            <button 
              onClick={() => window.location.href = '/'}
              className="bg-gradient-to-r from-blue-600 to-purple-600 text-white px-8 py-3 rounded-lg hover:from-blue-700 hover:to-purple-700 font-medium shadow-lg transition-all"
            >
              ← Return to Home
            </button>
          </div>
